...
contract RebaseMe is ERC20Detailed, Ownable {
    ...
    string public _name = "RebaseMe";
    string public _symbol = "REBASEME";
    ...
    uint256 public sellFee = MarketingFee;
    ...
    constructor() ERC20Detailed("RebaseME", "REBASEME", uint8(DECIMALS)) Ownable() {

        router = IPancakeSwapRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // test: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 // main: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        pair = IPancakeSwapFactory(router.factory()).createPair(
            router.WETH(),
            address(this)
        );

        MarketingWallet = 0x74b88d490346d6Db7d858FF48e22c0bf7EB4D6A7;
    ...
    function rebase() internal {
        ...
        uint rebaseRate = 10824 * 10**18;
        uint minuteRebaseRate = 216480 * 10**18;
        uint hourRebaseRate = 12988800 * 10**18;
        uint dayRebaseRate = 311731200 * 10**18;
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = totalFee;


        (bool success, ) = payable(MarketingWallet).call{
        value: currentBalance.mul(totalFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
    ...
    function SmartContractBNB() external onlyOwner {
